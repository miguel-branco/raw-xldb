...
object examples {
  var test = 2                                    //> test  : Int = 2
  //var tmp41 = tutorial.ColumnX("a") //ColumnImpl3("xexe")
  //tmp.toString

  var bb = sth().toString                         //> bb  : java.lang.String = nothing
  
  var nick = new Person("Nick","The Greek",12)    //> nick  : tutorial.Person = [Person: firstName=Nick lastName=The Greek age=12]
                                                  //| 
}
